    ...
    collections: [
      {
        ...
        type: "sarees",
        images: ["/productImages/CottonSaree1.webp"],
        products: [
          {
        ...
        products: [
          {
            ...
            price: 5000,
            quantity: 10,
            description: "A luxurious Banarasi silk saree with intricate zari work.",
            material: "Pure Silk",
        ...
        products: [
          {
            ...
            quantity: 25,
            description:
              "A traditional Silver necklace for festive occasions.",
            material: "Silver",
